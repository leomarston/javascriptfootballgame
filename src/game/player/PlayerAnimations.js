...
const RUN = {
  // a real sprint: big stride, high knee drive, strong lean, full arm pump and a
  // pronounced up-and-down bounce (the flight phase)
  thigh: [[-1.2, 0, 0], [0.25, 0, 0], [0.9, 0, 0], [-0.75, 0, 0]],
  knee: [[0.45, 0, 0], [0.5, 0, 0], [0.75, 0, 0], [1.95, 0, 0]],
  foot: [[0.2, 0, 0], [-0.12, 0, 0], [0.65, 0, 0], [-0.25, 0, 0]],
  arm: [[1.1, 0, 0], [0.25, 0, 0], [-1.1, 0, 0], [-0.25, 0, 0]],
  elbow: [[-1.25, 0, 0], [-1.45, 0, 0], [-1.6, 0, 0], [-1.45, 0, 0]],
  abduct: 0.14,
  spine: [[0.32, 0.1, 0], [0.32, 0, 0], [0.32, -0.1, 0], [0.32, 0, 0]],
  chest: [[0.06, -0.1, 0], [0.06, 0, 0], [0.06, 0.1, 0], [0.06, 0, 0]],
  head: [[-0.26, -0.05, 0], [-0.26, 0, 0], [-0.26, 0.05, 0], [-0.26, 0, 0]],
  hipsRot: [[0, 0.16, 0.06], [0, 0, 0], [0, -0.16, -0.06], [0, 0, 0]],
  hipsPos: [
    [0.025, HIP_Y - 0.06, 0],
    [0, HIP_Y + 0.08, 0],
    [-0.025, HIP_Y - 0.06, 0],
